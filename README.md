...
Aplicación de consola en Java (Spring Boot) para **registrar eventos**, **filtrarlos por fecha** y **configurar la
codificación** del fichero de log.
...
- Agarra la fecha del dispositivo de forma "automatica"
